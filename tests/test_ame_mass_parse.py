    ...
    expected = pd.DataFrame(
        {
            ...
            "AMERelativeError": [19.056 / 63742.471],
    ...
    expected = pd.DataFrame(
        {
            ...
            "AMERelativeError": [465.747 / 46574.693],
    ...
    expected = pd.DataFrame(
        {
            ...
            "AMERelativeError": [415.570 / 45692.348],
    ...
    expected = pd.DataFrame(
        {
            ...
            "AMERelativeError": [217.972 / 46068.530],
    ...
    expected = pd.DataFrame(
        {
            ...
            "AMERelativeError": [270.285 / 45610.155],
    ...
    expected = pd.DataFrame(
        {
            ...
            "AMERelativeError": [3.819 / 45708.416],
