...
def test_1995_nubase():
    line = io.StringIO(
        "168 0670   168Ho  -60085       29                              2.99   m 0.07   3+            94           B-=100"
    )
    ...
    expected = pd.DataFrame(
        {
            ...
            "NUBASERelativeError": [29 / 60085],
            "HalfLifeValue": [2.99],
            "HalfLifeUnit": ["min"],
            "HalfLifeError": [0.07],
            "HalfLifeSeconds": [179.4],
            "HalfLifeSecondsError": [4.2],
            "Spin": ["3+"],
            "DecayModes": ["B-=100"],
            "DataSource": [0],
        }
...
def test_2003_nubase():
    line = io.StringIO(
        "168 0670   168Ho  -60070       30                              2.99   m 0.07   3+            94           B-=100"
    )
